...
class KittiOdomLoader(object):
    ...
    def load_image(self, scene_data, tgt_idx):
        ...
        # Resize and preserve range and dtype
        img = resize(img, (self.img_height, self.img_width), preserve_range=True, anti_aliasing=True)
        img = img.astype(np.uint8)  # match the original imresize output
